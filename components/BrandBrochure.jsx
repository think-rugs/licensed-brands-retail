    ...
    flat.forEach(({ d, c }) => {
      ...
      c.sizes.forEach((s) => {
        lines.push([c.code, s.variant, c.title + ', ' + s.size, data.brand, (c.label || d.name),
          ...
          s.size, s.rrp, s.rrpEur].map(csvCell).join(','));
      });
    });
                ...
                <section className={'range' + (startsGroup ? ' group-start' : '')} key={d.name} id={'rg-' + slug(d.name)} data-range={d.name}>
                  ...
                  <header className="range-head">
                    ...
                    <p className="range-meta">
                      ...
                      <span className="range-from"> &middot; From <b>{gbp(d.fromRRP)}</b></span>
                    </p>
                    <div className="feats">
                  ...
                  <div className="grid">
                    {vis.map((c) => {
                      ...
                      const fromR = Math.min(...c.sizes.map((s) => s.rrp));
                      return (
                        <article
                          key={c.code}
                        ...
                        >
                          ...
                          <div className="card-body">
                            ...
                            <div className="card-foot">
                              ...
                              <span className="frm">From <b>{gbp(fromR)}</b></span>
                            </div>
                          </div>
                        </article>
                      );
