    ...
    <div className="landing">
      <header className="lp-canopy">
        ...
        <div className="lp-title">
          <p className="lp-eyebrow">Retail presentation</p>
      ...
      <footer className="lp-base">
        <p>Think Rugs, Licensed Brands 2026. Prices shown in the brochures are recommended retail prices in GBP and EUR.</p>
      </footer>
    </div>
  );
}
